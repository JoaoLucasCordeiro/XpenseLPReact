...
const ClientSlider = ({ clients }) => {
  return (
    <Swiper slidesPerView={1} spaceBetween={30} grabCursor={true} loop={true} 
    breakpoints={{640: {
      slidesPerView: 1,
      spaceBetween: 10,
    },
      ...
      {clients.map((client, index) => {
        ...
        return (
          <SwiperSlide key={index} style={{ borderColor: borderColor }} className='border-t-[10px] rounded-t-[12px]'>
            <div className='w-full mx-auto lg:max-w-[350px] h-[250px] rounded-[12px] border border-grey py-6 px-[30px]'>
