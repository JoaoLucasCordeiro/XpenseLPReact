    ...
    <section className='section bg-cta bg-cover bg-left-top'>
      <div className='max-w-[1340px] mx-auto px-[25px]'>
        ...
        <div className='flex justify-between'>
          <img className='hidden xl:flex' src={img1} alt="Imagem" data-aos='zoom-out-right' data-aos-delay='700' />
          ...
          <img className='hidden xl:flex' src={img2} alt="Imagem 2" data-aos='zoom-out-left' data-aos-delay='700' />
        </div>
