...
const Header = () => {
  ...
  return (
    <header className={`${isActive ? 'lg:top-0 bg-white shadow-2x1' : 'lg:top-[60px]'} py-6 lg:py-4 fixed w-full transition-all z-10`}>
      ...
      <div className='container mx-auto flex justify-between items-center'>
        ...
        <div className='hidden lg:flex 4'  data-aos='fade-down' data-aos-delay='1200'>
          <Nav />
        </div>
        ...
        <button className='lg:hidden' onClick={() => setMobileNav(!mobileNav)}>
          {mobileNav ? (<HiOutlineX className='text-3x1 text-accent' />)
